...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC1, LL_ADC_CHANNEL_VOPAMP1, LL_ADC_SAMPLINGTIME_247CYCLES_5);
...
void MX_ADC2_Init(void)
{
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC2, LL_ADC_CHANNEL_VOPAMP2, LL_ADC_SAMPLINGTIME_247CYCLES_5);
...
void MX_ADC3_Init(void)
{
  ...
  */
  ...
  /** Configure Regular Channel
  */
  LL_ADC_REG_SetSequencerRanks(ADC3, LL_ADC_REG_RANK_1, LL_ADC_CHANNEL_VOPAMP3_ADC3);
  LL_ADC_SetChannelSamplingTime(ADC3, LL_ADC_CHANNEL_VOPAMP3_ADC3, LL_ADC_SAMPLINGTIME_247CYCLES_5);
  LL_ADC_SetChannelSingleDiff(ADC3, LL_ADC_CHANNEL_VOPAMP3_ADC3, LL_ADC_SINGLE_ENDED);
